...
const Nosotros = () => {
  return (
    <div id='nosotros'>
        <div>
            <h2 class="font-bold text-2xl md:text-5xl lg:text-6xl text-start mx-6 md:mx-12 lg:mx-24"><div class="bg-quaternary w-36 md:w-72 h-6 md:h-12 flex items-center justify-center">Nosotros</div></h2>
        </div>
        <div class=" m-6 md:mx-12 flex flex-col place-content-center lg:flex-row">
            <div class="lg:w-1/2 lg:mx-20 lg:mt-10 text-justify lg:flex lg:flex-col lg:justify-center">
